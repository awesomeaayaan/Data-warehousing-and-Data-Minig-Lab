...
def toy_dataset():
    ...
    [50,19],[20,20],[44,21],[46,18],[51,19],[50,10],[40,22],[50,23],[49,53],
    [50,25],[50,50],[50,45],[44,51],[46,55],[51,48],[50,58],
    [40,49],[50,55],[49,53],[50,52],[25,80],[100,30],[150,90]])
...
def main():
    data = toy_dataset()
    print('Cluster constructed by DBSCAN:')
